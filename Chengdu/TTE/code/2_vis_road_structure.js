...
async function loadGeoJsonData() {
    ...
    try {
        nodesGeoJsonCache = JSON.parse(fs.readFileSync('../data/road_structure_trajectory_htmls/chengdu_nodes.geojson', 'utf8'));
        console.log(`Loaded node data: ${nodesGeoJsonCache.features.length} nodes`);
        edgesGeoJsonCache = JSON.parse(fs.readFileSync('../data/road_structure_trajectory_htmls/chengdu_edges.geojson', 'utf8'));
