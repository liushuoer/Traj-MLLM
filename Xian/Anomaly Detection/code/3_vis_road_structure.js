...
async function loadGeoJsonData() {
    ...
    try {
        nodesGeoJsonCache = JSON.parse(fs.readFileSync('../data/road_structure_anomaly_htmls/nodes.geojson', 'utf8'));
        console.log(`Loaded node data: ${nodesGeoJsonCache.features.length} nodes`);
        edgesGeoJsonCache = JSON.parse(fs.readFileSync('../data/road_structure_anomaly_htmls/edges.geojson', 'utf8'));
